...
# from the release checksums file (`hacienda_mcp_<version>_checksums.txt`). This
...
VERSION="$1"
SUMS="$2"
BASE="https://github.com/jamon8888/Hacienda-mind/releases/download/v${VERSION}"
...
class Basemind < Formula
  ...
  homepage "https://github.com/jamon8888/Hacienda-mind"
  version "${VERSION}"
  license "MIT"
  ...
  def install
    ...
    libexec.install Dir["*"]
    bin.install_symlink libexec/"hacienda-mcp"
  end

  test do
    assert_match version.to_s, shell_output("#{bin}/hacienda-mcp --version")
  end
end
EOF
