...
hacienda-mcp pre-indexes your codebase using tree-sitter, mapping symbols, calls, and imports
...
- **Do not re-read a file hacienda-mcp already mapped.** If the outline answered the question,
  stop.
