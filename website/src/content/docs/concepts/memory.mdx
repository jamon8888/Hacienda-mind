...
hacienda-mcp provides a shared memory layer scoped to your repository: agents can store notes, search
...
hacienda-mcp watches how your files evolve and suggests notes worth saving. When it spots files that
